...
Latest version: 1.6.4 see the [CHANGELOG](https://github.com/jgrodziski/metav/blob/master/CHANGELOG.md).

[deps.edn](https://clojure.org/guides/deps_and_cli) dependency information:
```
{metav {:mvn/version "1.6.4"}}
```
...
Or using the clojars version `{metav {:mvn/version "1.6.4"}}` :
```clojure
{:aliases {:metav {:extra-deps {metav {:mvn/version "1.6.4"}}}
           :artifact-name {:extra-deps {metav {:mvn/version "1.6.4"}}
                           :main-opts ["-m" "metav.display"]}
           :release {:extra-deps {metav {:mvn/version "1.6.4"}}
                     :main-opts ["-m" "metav.release"]}
           :spit     {:extra-deps {metav {:mvn/version "1.6.4"}}
